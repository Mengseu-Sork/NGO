...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white p-4 sm:p-6 rounded-2xl shadow hover:shadow-lg transition">
        <h2 class="font-semibold text-lg text-green-700 mb-4">Membership Growth</h2>
        <canvas id="lineChart" class="h-48 sm:h-56"></canvas>
    </div>

    <!-- Pie Chart -->
    <div class="bg-white p-4 sm:p-6 rounded-2xl shadow hover:shadow-lg transition flex flex-col sm:flex-row items-center sm:items-start">
